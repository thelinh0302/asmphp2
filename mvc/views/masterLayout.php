              ...
              <ul class="site-menu main-menu js-clone-nav mr-auto d-none d-lg-block">
                ...
                <?php
                  if(isset($_SESSION["user_customer"])){
                      "<li><a href='controller.php?action=login' style='display:none' >Login</a></li>";
                      echo "<li  class='copy' ><a href='./Admin/logout_user'>user</a><i class='fas fa-user'></i>
                            
                            ";
                  }elseif(isset($_SESSION['userAdmin'])){
                      "<li><a href='' style='display:none' >Login</a></li>";
                      echo "<li  class='copy' ><i class='fas fa-user'style='font-size:24px;color:#ffff' ></i>
                                <ul>
                                  <li><a href='./prAdmin'>Admin</a></li>
                                </ul>
                          </li>";
                  }else{
            ...
            <div class="row">
              ...
              <div class="col-md-3 mx-auto">
                ...
                <ul class="list-unstyled">
                  <li><a href="./product/product">About Us</a></li>
