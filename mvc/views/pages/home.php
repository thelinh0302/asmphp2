<div class="site-block-wrap">
    <div class="owl-carousel with-dots">
      <div class="site-blocks-cover overlay overlay-2" style="background-image: url(./public/images/hero_1.jpg);" data-aos="fade" id="home-section">
      ...
      <div class="site-blocks-cover overlay overlay-2" style="background-image: url(./public/images/hero_2.jpg);" data-aos="fade" id="home-section">
  ...
  <div class="site-section" id="properties-section">
      ...
      <div class="row mb-5">
          <div class="col-md-7 text-left">
            <a href="./product/product"><h2 class="section-title mb-3">All Product</h2></a>  
          </div>
        </div>
        ...
        <div class="row large-gutters">
          <div class="col-lg-6 mb-5">
              ...
              <div class="owl-carousel slide-one-item with-dots">
                  <div><img src="./public/images/img_1.jpg" alt="Image" class="img-fluid"></div>
                  <div><img src="./public/images/img_2.jpg" alt="Image" class="img-fluid"></div>
                  <div><img src="./public/images/img_3.jpg" alt="Image" class="img-fluid"></div>
                </div>
            ...
            <div class="col-md-6 mb-4">
                <div class="ftco-testimonial-1">
                  <div class="ftco-testimonial-vcard d-flex align-items-center mb-4">
                    <img src="./public/images/person_1.jpg" alt="Image" class="img-fluid mr-3">
                    <div>
              ...
              <div class="col-md-6 mb-4">
                  <div class="ftco-testimonial-1">
                      <div class="ftco-testimonial-vcard d-flex align-items-center mb-4">
                        <img src="./public/images/person_2.jpg" alt="Image" class="img-fluid mr-3">
                        <div>
                          <h3>James Phelps</h3>
                          <span>Customer</span>
                        </div>
              ...
              <div class="col-md-6 mb-4">
                  <div class="ftco-testimonial-1">
                    <div class="ftco-testimonial-vcard d-flex align-items-center mb-4">
                      <img src="./public/images/person_3.jpg" alt="Image" class="img-fluid mr-3">
                      <div>
                        <h3>Nestor Helsin</h3>
                        <span>Customer</span>
                      </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="h-entry">
              <a href="single.html"><img src="./public/images/img_1.jpg" alt="Image" class="img-fluid"></a>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="h-entry">
              <a href="single.html"><img src="./public/images/img_2.jpg" alt="Image" class="img-fluid"></a>
              <h2 class="font-size-regular"><a href="single.html" class="text-dark">Popular Real Estate Properties for 2019</a></h2>
          ...
          <div class="col-md-6 col-lg-4 mb-4 mb-lg-4">
            <div class="h-entry">
              <a href="single.html"><img src="./public/images/img_3.jpg" alt="Image" class="img-fluid"></a>
              <h2 class="font-size-regular"><a href="single.html" class="text-dark">Popular Real Estate Properties for 2019</a></h2>
              <div class="meta mb-4">Allison Holmes <span class="mx-2">&bullet;</span> Jan 18, 2019<span class="mx-2">&bullet;</span> <a href="single.html">News</a></div>
            </div> 
          </div>
